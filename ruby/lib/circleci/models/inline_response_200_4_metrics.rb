...
module CircleCi
  ...
  class InlineResponse2004Metrics
    ...
    attr_accessor :median_credits_used
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CircleCi::InlineResponse2004Metrics` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CircleCi::InlineResponse2004Metrics`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'median_credits_used')
        self.median_credits_used = attributes[:'median_credits_used']
      end
    ...
    def list_invalid_properties
      ...
      if @median_credits_used.nil?
        invalid_properties.push('invalid value for "median_credits_used", median_credits_used cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @median_credits_used.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          median_credits_used == o.median_credits_used &&
    ...
    def hash
      [total_runs, failed_runs, successful_runs, throughput, median_credits_used, total_credits_used, duration_metrics].hash
    end
