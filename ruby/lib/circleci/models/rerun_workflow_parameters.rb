  ...
  class RerunWorkflowParameters
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CircleCi::RerunWorkflowParameters` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CircleCi::RerunWorkflowParameters`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'enable_ssh')
        self.enable_ssh = attributes[:'enable_ssh']
      end

      if attributes.key?(:'from_failed')
        self.from_failed = attributes[:'from_failed']
      end
      ...
      if attributes.key?(:'sparse_tree')
        self.sparse_tree = attributes[:'sparse_tree']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          from_failed == o.from_failed &&
          jobs == o.jobs &&
          sparse_tree == o.sparse_tree
    end
    ...
    def hash
      [enable_ssh, from_failed, jobs, sparse_tree].hash
    end
