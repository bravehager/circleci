...
module CircleCi
  ...
  class InlineResponse2003ProjectDataMetrics
    # The total number of runs.
    attr_accessor :total_runs

    # Total duration, in seconds.
    attr_accessor :total_duration_secs
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CircleCi::InlineResponse2003ProjectDataMetrics` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CircleCi::InlineResponse2003ProjectDataMetrics`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'total_duration_secs')
        self.total_duration_secs = attributes[:'total_duration_secs']
      end
    ...
    def list_invalid_properties
      ...
      if @total_duration_secs.nil?
        invalid_properties.push('invalid value for "total_duration_secs", total_duration_secs cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @total_duration_secs.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          total_duration_secs == o.total_duration_secs &&
    ...
    def hash
      [total_runs, total_duration_secs, total_credits_used, success_rate, throughput].hash
    end
