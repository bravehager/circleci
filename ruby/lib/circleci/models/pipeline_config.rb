...
module CircleCi
  ...
  class PipelineConfig
    ...
    attr_accessor :compiled_setup_config
    ...
    def self.attribute_map
      {
        ...
        :'compiled_setup_config' => :'compiled-setup-config'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CircleCi::PipelineConfig` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CircleCi::PipelineConfig`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'setup_config')
        self.setup_config = attributes[:'setup_config']
      end

      if attributes.key?(:'compiled_setup_config')
        self.compiled_setup_config = attributes[:'compiled_setup_config']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @compiled.nil?
        invalid_properties.push('invalid value for "compiled", compiled cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          source == o.source &&
          compiled == o.compiled &&
          setup_config == o.setup_config &&
          compiled_setup_config == o.compiled_setup_config
    end
    ...
    def hash
      [source, compiled, setup_config, compiled_setup_config].hash
    end
